    ...
    if (isLoading) {
      fetchUserData().then(datanew => {
        if (datanew === null || undefined) {
          ...
          id = datanew.reg_no
          dept = datanew.dept
          if(dept === "eve" && datanew.role === "admin"){
            console.log("admin of event")
          }
          else if(dept === "eve" && datanew.role === "core"){
            console.log("core of event")
          }
          else if(datanew.role === "core"){
            console.log("core of non event")
          }
          else if(dept === "eve" && datanew.role === "user"){
