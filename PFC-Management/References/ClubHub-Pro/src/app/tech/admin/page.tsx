...
export default function Page() {
  ...
  useEffect(() => {
    ...
    if (isLoading) {
      fetchUserData().then(datanew => {
        ...
        if(dept === "tec" && datanew.role === "admin"){
          console.log("admin of tech")
        }
        else if(dept === "tec" && datanew.role === "core"){
          console.log("core of tech")
        }
        else if(datanew.role === "core"){
          console.log("core of non tech")
        }
        else if(dept === "tec" && datanew.role === "user"){
  ...
  const fetchApprovedTasks = async (assigenr_id: any) => {
    console.log("data inside fetchApprovedTasks is:", assigenr_id)
    setIsFetching(true)
