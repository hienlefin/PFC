      ...
      if (isLoading) {
        fetchUserData().then(datanew => {
          if (datanew === null || undefined) {
            ...
            id = datanew.reg_no
            dept = datanew.dept
            if (dept === "des" && datanew.role === "admin") {
              console.log("admin of design")
            }
            else if (dept === "des" && datanew.role === "core") {
              console.log("core of tecdesign")
            }
            else if (datanew.role === "core") {
              console.log("core of non design")
            }
            else if (dept === "des" && datanew.role === "user") {
