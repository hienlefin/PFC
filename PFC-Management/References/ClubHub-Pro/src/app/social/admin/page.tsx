    ...
    if (isLoading) {
      fetchUserData().then(datanew => {
        if (datanew === null || undefined) {
          ...
          id = datanew.reg_no
          dept = datanew.dept
          if(dept === "soc" && datanew.role === "admin"){
            console.log("admin of social")
          }
          else if(dept === "soc" && datanew.role === "core"){
            console.log("core of social")
          }
          else if(datanew.role === "core"){
            console.log("core of non social")
          }
          else if(dept === "soc" && datanew.role === "user"){
